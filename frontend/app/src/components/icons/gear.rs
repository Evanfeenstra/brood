...
impl Component for Gear {
    ...
    fn view(&self) -> Html {
        if self.active {
            return html! {<div class="gear-icon" onclick=self.link.callback(|_| Msg::Clicked)>
                <svg class="gear" fill="#FFFFFF" viewBox="0 0 1024 1024">
        ...
        html! {<div class="gear-icon" onclick=self.link.callback(|_| Msg::Clicked)>
            <svg class="gear" fill="#FFFFFF" viewBox="0 0 1024 1024">
